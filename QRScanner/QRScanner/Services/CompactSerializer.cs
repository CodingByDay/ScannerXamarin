...
namespace QRScanner.Core.App
{
    public class CompactSerializer
    {
        ...
        public static string Serialize<T>(T value)
        {
            ...
            {
                QRScanner.Appclasses.Log.Write(new QRScanner.Appclasses.LogEntry("END REQUEST: [Device/CompactSerializer.Serialize];" + (DateTime.Now - startedAt).TotalMilliseconds.ToString()));
        ...
        public static T Deserialize<T>(string xml)
        {
            ...
            {
                QRScanner.Appclasses.Log.Write(new QRScanner.Appclasses.LogEntry("END REQUEST: [Device/CompactSerializer.Deserialize];" + (DateTime.Now - startedAt).TotalMilliseconds.ToString()));
